...
#define TIME_TO_SLEEP_USUAL 60
#define TIME_TO_SLEEP_ERROR 300
...
void sendRequest(String _action){
  ...
  if(!client.connect(host,httpPort)){
    ...
    sleeptime_error =TIME_TO_SLEEP_ERROR * 1000000 - (millis() -starttime) * 1000;
    esp_deep_sleep(sleeptime_error);
  }
...
// delay(15000);
//Deep sleepする時間を計算する
uint64_t sleeptime =TIME_TO_SLEEP_USUAL * 1000000 - (millis() -starttime) * 1000;
